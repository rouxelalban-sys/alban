...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://uqvlfypjpgcubpmejqky.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_akUg3CaJheNW-l9j-WtTvw_klhPg20a';
...
<header class="topbar" id="topbar" role="navigation" aria-label="Quick stats">
  ...
  <a href="brain.html" class="topbar-pill" id="topbarBrain">
    <span class="topbar-pill-dot"></span>
    <span class="topbar-pill-label">BRAIN</span>
  </a>
